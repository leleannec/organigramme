package nc.noumea.mairie.organigramme.authentification;
...
import nc.noumea.mairie.organigramme.core.authentification.AuthentificationFilter;
...
public class AuthentificationFilterTest {
	...
	public void convertRemoteUser_withAt() {
		...
		Assert.assertEquals("rebjo84", result);
	}
