...
@Repository("couleurTypeEntiteDao")
public class CouleurTypeEntiteDaoImpl extends GenericDaoImpl<CouleurTypeEntite> implements CouleurTypeEntiteDao {

	@Override
	public CouleurTypeEntite findByIdTypeEntite(Long idTypeEntite) {
		try {
			return findSingleByProperty(CouleurTypeEntite.class, "idTypeEntite", idTypeEntite);
