...
public class SirhWSConsumer extends BaseWsConsumer implements ISirhWSConsumer {
	...
	private static final String URL_TREE_FICHE_POSTE_PAR_ENTITE = "fichePostes/treeFichesPosteByIdEntite";
	...
	public List<FichePosteDto> getFichePosteByIdEntite(Integer idEntite, String listIdStatutFDP,
		...
		params.put("statutFDP", String.valueOf(listIdStatutFDP));
